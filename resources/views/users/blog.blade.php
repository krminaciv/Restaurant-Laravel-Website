...
<div class="wrapper d-flex align-items-stretch">
     ...
     <div id="content" class="p-4 p-md-5">
          ...
          <h2 class="mb-4">Додајте Нови Чланак</h2>
          ...
          <div class="card-body">
               ...
               <form method="POST" action="/dashboard/blog" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                         <div class="name">Наслов</div>
                         <div class="value">
                              <input class="input--style-6" type="text" name="title">
                         </div>
                    </div>
                    <div class="form-row">
                         <div class="name">Садржај</div>
                         <div class="value">
                              <div class="input-group">
                                   <textarea class="textarea--style-6" name="text"
                                        placeholder="Message sent to the employer" rows="20"></textarea>
                              </div>
                         </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                         <div class="name">Тагови</div>
                         <div class="value">
                              <input class="input--style-6" type="text" name="tags">
                         </div>
                    </div>
                    <div class="form-row">
                         ...
                         <div class="value">
                              <div class="input-group js-input-file">
                                   ...
                                   <span class="input-file__info">Није одабрана датотека</span>
                              </div>
