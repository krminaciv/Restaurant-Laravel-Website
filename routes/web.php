...
Route::delete('/dashboard/reservations/{id}', [UserController::class, 'deleteReservation'])->middleware('auth');

Route::get('/dashboard/comments/', [UserController::class, 'showComments'])->middleware('auth');
Route::delete('/dashboard/comments/{id}', [UserController::class, 'deleteComment'])->middleware('auth');
...
Route::delete('/dashboard/menu/{id}', [UserController::class, 'deleteMenu'])->middleware('auth');
...
Route::delete('/dashboard/blog/{id}', [UserController::class, 'deleteBlog'])->middleware('auth');
